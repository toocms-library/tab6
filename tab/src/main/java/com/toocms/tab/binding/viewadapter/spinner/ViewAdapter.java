package com.toocms.tab.binding.viewadapter.spinner;
...
public class ViewAdapter {
    ...
    public static void onItemSelectedCommand(final Spinner spinner,
                                             final List<IKeyAndValue> itemDatas,
                                             String valueReply,
                                             int resource,
                                             int dropDownResource,
                                             final BindingCommand<IKeyAndValue> bindingCommand) {
        if (itemDatas == null) {
