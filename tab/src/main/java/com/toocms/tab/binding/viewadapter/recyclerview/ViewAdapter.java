...
public class ViewAdapter {
    ...
    @BindingAdapter(value = {"layoutManagerFactory", "spanSizeLookup"}, requireAll = false)
    ...
    public static class OnScrollListener extends RecyclerView.OnScrollListener {
        ...
        public OnScrollListener(final BindingCommand<Integer> onLoadMoreCommand) {
            ...
            methodInvoke.throttleFirst(1, TimeUnit.SECONDS).subscribe(integer -> onLoadMoreCommand.execute(integer));
        }
