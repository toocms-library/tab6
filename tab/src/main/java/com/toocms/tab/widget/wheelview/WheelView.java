package com.toocms.tab.widget.wheelview;
...
import com.toocms.tab.widget.wheelview.listener.LoopViewGestureListener;
import com.toocms.tab.widget.wheelview.listener.OnItemSelectedListener;
import com.toocms.tab.widget.wheelview.timer.InertiaTimerTask;
import com.toocms.tab.widget.wheelview.timer.MessageHandler;
import com.toocms.tab.widget.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            LogUtils.eTag("WheelView", "出错了！adapter.getItemsCount() == 0，联动数据不匹配");
        }
        if (!isLoop) {//不循环的情况
