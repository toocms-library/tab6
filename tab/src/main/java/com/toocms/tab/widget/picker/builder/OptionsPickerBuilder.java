package com.toocms.tab.widget.picker.builder;
...
import com.toocms.tab.widget.picker.listener.OnOptionsSelectChangeListener;
...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder(Context context, OnOptionsSelectListener listener) {
        ...
        mPickerOptions.textColorConfirm = QMUIResHelper.getAttrColor(context, R.attr.colorAccent);
        mPickerOptions.textColorCancel = QMUIResHelper.getAttrColor(context, R.attr.colorAccent);
    }
