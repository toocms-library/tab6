...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            if (isDialog()) {
                LayoutInflater.from(context).inflate(R.layout.picker_layout_view_options_dialog, contentContainer);
            } else {
                LayoutInflater.from(context).inflate(R.layout.picker_layout_view_options, contentContainer);
            }
