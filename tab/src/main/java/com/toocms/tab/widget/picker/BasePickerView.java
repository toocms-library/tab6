package com.toocms.tab.widget.picker;
...
import com.toocms.tab.widget.picker.configure.PickerOptions;
import com.toocms.tab.widget.picker.listener.OnDismissListener;
import com.toocms.tab.widget.picker.utils.PickerViewAnimateUtils;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.picker_layout_view_base, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.picker_layout_view_base, mPickerOptions.decorView, false);
    ...
    private void setWindowMaxWidth(Window dialogWindow) {
        ...
        int windowHorizontalPadding = ConvertUtils.dp2px(40);
        int maxWidth = ConvertUtils.dp2px(350);
