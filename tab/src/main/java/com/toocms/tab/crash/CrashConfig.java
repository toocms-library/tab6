...
public class CrashConfig implements Serializable {
    ...
    public void setEventListener(@Nullable CrashStore.EventListener eventListener) {
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            CrashConfig currentConfig = CrashStore.getConfig();
         ...
         * The default is R.drawable.ic_crash_image (a cute upside-down bug).
         */
        @NonNull
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable CrashStore.EventListener eventListener) {
